...
class CryptCord {
    constructor(){
        this.toggle = false;
        this.key = "0123456789ABCDEF0123456789ABCDEF"; // The DEFAULT Key. Please do not use this.
        var libraryScript;

        this.encryption = "aes256";
    ...
    getSettingsPanel(){
        ...
        <table>
            <tr>
                <td><button onclick="BdApi.getPlugin('${this.getName()}').randomKey(32)" style="font-size: 12px !important;background: #e54e4e;color: #FFF;border-radius: 5px;">Generate 32 Bit Key</button></td>
                <td><button onclick="BdApi.getPlugin('${this.getName()}').randomKey(64)" style="font-size: 12px !important;background: #e0cb43;color: #FFF;border-radius: 5px;">Generate 64 Bit Key</button></td>
                <td><button onclick="BdApi.getPlugin('${this.getName()}').randomKey(128)" style="font-size: 12px !important;background: #47c134;color: #FFF;border-radius: 5px;">Generate 128 Bit Key</button></div></td>
                <td><button onclick="BdApi.getPlugin('${this.getName()}').randomKey(128)" style="font-size: 12px !important;background: #b643e0;color: #FFF;border-radius: 5px;">Generate 256 Bit Key</button></div></td>
            </tr>
            <tr>
                <td style="text-align: center;">Least Secure</td>
                <td style="text-align: center;">Kinda Secure</td>
                <td style="text-align: center;">Very Secure</td>
                <td style="text-align: center;">Expirimental!</td>
            </tr>
        </table>
       <div style="float: right;"><button onclick="BdApi.getPlugin('${this.getName()}').saveSettings()" style="background: #7289da;color: #FFF;border-radius: 5px;">Save Settings</button></div>`;
    }
